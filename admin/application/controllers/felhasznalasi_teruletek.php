...
use ShopManager\FelhasznalasiTerulet;

class felhasznalasi_teruletek extends Controller {
		function __construct(){
			parent::__construct();
			parent::$pageTitle = 'Felhasználási területek / Adminisztráció';
			...
			if ( $this->view->gets[1] == 'szerkeszt') {
				// Kategória adatok
				$cat_data = new FelhasznalasiTerulet( $this->view->gets[2],  array( 'db' => $this->db )  );
