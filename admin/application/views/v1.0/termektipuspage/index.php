...
<h1>Termék típusok</h1>
<p>
	Itt létrehozhatja a termék típusokat és a hozzá tartozó mellékterméket. Mellékterméknek számít az az elem, amelyiknek van szülő eleme. 
</p>
<? if($this->err): ?>
	<?=$this->bmsg?>
<? endif; ?>
<div class="row">
	<div class="col-md-4">
		...
		<div class="con con-del">
			<h2>Elem törlése</h2>
			Biztos benne, hogy törli a(z) <strong><u><?=$this->category_d->getName()?></u></strong> elnevezésű termék típust? A művelet nem visszavonható!
			<div class="row np">
				<div class="col-md-12 right">
					<form action="" method="post">
						<a href="/termektipuspage/" class="btn btn-danger"><i class="fa fa-times"></i> Mégse</a>
		...
		<div class="con <?=($this->category ? 'con-edit':'')?>">
			<h2><?=($this->category ? 'Termék típus szerkesztése':'Új termék típus létrehozás')?></h2>
			<div>
				<form action="" method="post">
					<div class="row np">
                  ...
                  <span class="input-group-addon">
					...
					<div class="row np">
						<div class="col-md-12">
							<label for="parent_category">Szülő elem</label>
	...
	<div class="col-md-8">
		<div class="con">
			<h2>Termék típusok / melléktermék</h2>
			<?
				if( false ):
				while( $this->categories->walk() ):
				$cat = $this->categories->the_cat();
			...
			<div class="row np row-head">
				<div class="col-md-9"><em>Típus / Melléktermék</em></div>
			...
			<div class="categories">
				...
				<div class="row np deep<?=$cat['deep']?> <?=($this->category && $this->category->getId() == $cat['ID'] ? 'on-edit' : ( $this->category_d && $this->category_d->getId() == $cat['ID'] ? 'on-del':'') )?>">
					<div class="col-md-9">
						<a href="/termektipuspage/szerkeszt/<?=$cat['ID']?>" title="Szerkesztés"><strong><?=$cat['neve']?></strong></a>
          ...
          <div class="col-md-1 actions" align="right">
          	<a href="/termektipuspage/torles/<?=$cat['ID']?>" title="Törlés"><i class="fa fa-times"></i></a>
          </div>
				</div>
				<? endwhile; ?>
			</div>
