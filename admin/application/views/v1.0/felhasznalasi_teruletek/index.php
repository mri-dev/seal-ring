...
<div class="row">
	<div class="col-md-4">
		...
		<div class="con con-del">
			<h2>Elem törlése</h2>
			Biztos benne, hogy törli a(z) <strong><u><?=$this->category_d->getName()?></u></strong> elnevezésű felhasználási területet? A művelet nem visszavonható!
			<div class="row np">
				<div class="col-md-12 right">
					<form action="" method="post">
						<a href="/felhasznalasi_teruletek/" class="btn btn-danger"><i class="fa fa-times"></i> Mégse</a>
		...
		<div class="con <?=($this->category ? 'con-edit':'')?>">
			<h2><?=($this->category ? 'Felhasználási területek szerkesztése':'Új felhasználási területek létrehozás')?></h2>
			<div>
				<form action="" method="post">
					<div class="row np">
	...
	<div class="col-md-8">
		<div class="con">
			...
			<div class="row np row-head">
				<div class="col-md-9"><em>Elnevezés</em></div>
			...
			<div class="categories">
				...
				<div class="row np deep<?=$cat['deep']?> <?=($this->category && $this->category->getId() == $cat['ID'] ? 'on-edit' : ( $this->category_d && $this->category_d->getId() == $cat['ID'] ? 'on-del':'') )?>">
					<div class="col-md-9">
						<a href="/felhasznalasi_teruletek/szerkeszt/<?=$cat['ID']?>" title="Szerkesztés"><strong><?=$cat['neve']?></strong></a>
          ...
          <div class="col-md-1 actions" align="right">
          	<a href="/felhasznalasi_teruletek/torles/<?=$cat['ID']?>" title="Törlés"><i class="fa fa-times"></i></a>
          </div>
				</div>
				<? endwhile; ?>
			</div>
