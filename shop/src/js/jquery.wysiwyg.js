...
function __(s) {
    switch (s) {
        case 'Click to Bold':
            s = "Félkövér";
            break;
        case 'Click to Italic':
            s = "Dőlt";
            break;
        case 'Click to Underline':
            s = "Aláhúzott";
            break;
        case 'Left Align':
            s = "Balra igazít";
        ...
        case 'Open In':
            ...
            break;
        case 'Add/Edit Link':
            s = "Link hozzáadása/szerkesztése";
            break;
        case 'Add/Edit Img':
            s = "Kép hozzáadása/szerkesztése";
            break;
        case 'Current Window':
            s = "helyben";
            break;
        case 'New Window':
            s = "másik ablakban";
            break;
        case 'Click to Strike Through':
            s = "Legyen áthúzott";
            break;
        case 'Remove Formatting':
            s = "Formázás eltávolítása";
            break;
        case 'Paragraph':
            s = "Bekezdés";
            break;
...
var nicEditorConfig = bkClass.extend({
    buttons: {
        ...
        'yt': {
            name: 'Youtube videó beszúrás',
            command: 'insertYTvideo',
            noActive: true
        }
    },
                ...
                switch (A) {
                    case "text":
						if(typeof S !== 'undefined'){	
							if(S.width != '' && itm == 'width'){
								F = S.width;
							}
							if(S.height != '' && itm == 'height'){
								F = S.height;
							}
						}	
    ...
    submit: function(B) {
        ...
        if (this.im) {
			...
			if(w != ''){
				...
				this.im.style.width 	= w;
			}else{
				this.im.style.width = 'auto';
			}
			...
			if(h != ''){
				...
				this.im.style.height 	= h;
			}else{
				this.im.style.height = 'auto';
			}
