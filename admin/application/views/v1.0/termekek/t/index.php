				...
				<div class="con">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="">
								<div class="">
									<input type="radio" id="fht0" name="felhasznalasi_terulet" <?=(!$this->termek['felhasznalasi_terulet'])?'checked="checked"':''?> value="0"> <label for="fht0">Nincs meghatározva</label>
								</div>
								<?php
									while( $this->felhasznalasi_teruletek->walk() ):
									$fht = $this->felhasznalasi_teruletek->the_cat();?>
									<div class="">
										<input type="radio" id="fht<?=$fht['ID']?>" <?=($this->termek['felhasznalasi_terulet'] == $fht['ID'])?'checked="checked"':''?> name="felhasznalasi_terulet" value="<?=$fht['ID']?>"> <label for="fht<?=$fht['ID']?>"><? echo $fht['neve']; ?></label>
									</div>
									<?php endwhile; ?>
							</div>
						</div>
