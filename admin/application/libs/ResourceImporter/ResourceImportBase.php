    ...
    foreach ( (array)$prepare as $r ) {
      ...
      */
      ...
      $insert_row[] = array(
        ...
        'beszerzes_netto' => (float)str_replace(",",".",$r['beszerzes_netto']),
        'nagyker_ar_netto' => (float)str_replace(",",".",$r['nagyker_ar_netto']),
        'kisker_ar_netto' => (float)str_replace(",",".",$r['kisker_ar_netto']),
        'termek_keszlet' => (float)str_replace(",",".",$r['termek_keszlet']),
        ...
        'ar1' => (float)str_replace(",",".",$r['ar1']),
        'ar2' => (float)str_replace(",",".",$r['ar2']),
        'ar3' => (float)str_replace(",",".",$r['ar3']),
        'ar4' => (float)str_replace(",",".",$r['ar4']),
        'ar5' => (float)str_replace(",",".",$r['ar5']),
        'ar6' => (float)str_replace(",",".",$r['ar6']),
        'ar7' => (float)str_replace(",",".",$r['ar7']),
        'ar8' => (float)str_replace(",",".",$r['ar8']),
        'ar9' => (float)str_replace(",",".",$r['ar9']),
        'ar10' => (float)str_replace(",",".",$r['ar10']),
        'io' => 1
      );
