    ...
    <tbody>
    	...
    	<tr class="color-schame">
	    	...
	    	<td class="center">
				...
				<td class="center">
					<? if($d['kiemelt'] == '1'): ?>
					<i class="fa fa-check vtgl" vmode="kiemelt" title="Kiemelt / Kattintson a kiemelés levételéhez" tid="<?=$d['doc_id']?>"></i>
				<? else: ?>
					<i class="fa fa-times vtgl" vmode="kiemelt" title="Nem kiemelt / Kattintson a kiemeléshez" tid="<?=$d['doc_id']?>"></i>
				<? endif; ?>
				</td>
	    	<td class="center">
	    		<? if( isset($d['doc_title']) ): ?>
