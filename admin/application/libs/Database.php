...
DELIMITER ;";
			...
			$f .= "DROP FUNCTION IF EXISTS TEXTDIFF;
				DELIMITER $$
				CREATE FUNCTION TEXTDIFF(szoveg text, keres text)
					RETURNS SMALLINT
				BEGIN
					DECLARE test TEXT;
					DECLARE leftcnt SMALLINT DEFAULT 100;

					SET test = REPLACE(szoveg, keres, '');
					SET test = REPLACE(test,' ', '');
					SET leftcnt = LENGTH(test);
