	...
	<div class="col-md-12">
		<div class="con">
            ...
            <form action="" role="form" method="post">
            	<div class="row">
								<div class="col-md-2">
                	<label for="nagyker_id">Gyüjtő kiválasztása</label>
                	<select class="form-control" name="nagyker_id" id="nagyker_id">
                  	<option value="">-- válasszon --</option>
                  	<option value="" disabled></option>
                  	<? foreach( $this->nagykerek as $nagyker ): ?>
                	...
                	<input type="text" id="mnev" name="mnev" class="form-control">
								...
								<div class="col-md-4">
                	<label for="image">Márka képe</label>
									<div class="input-group">
											<input type="text" id="image" name="image" class="form-control" value="">
											<div class="input-group-addon"><a title="Kép kiválasztása a galériából" href="<?=FILE_BROWSER_IMAGE?>&field_id=image" data-fancybox-type="iframe" class="iframe-btn" ><i class="fa fa-link"></i></a></div>
									</div>
                </div>
                <div class="col-md-3">
